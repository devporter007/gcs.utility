...
namespace GCCS_GUI
{
    public partial class main : Form
    {
        ...
        {
            application = $"B: && cd B:\\ && cd {main.path}\\ && cd PlanetZoo && PlanetZoo.exe";
        ...
        {
            MessageBox.Show("This part of app is in development, expect bugs");
            ...
            application = $"B: && cd B:\\ && cd {main.path}\\ && cd Ghostrunner && Ghostrunner.exe";
